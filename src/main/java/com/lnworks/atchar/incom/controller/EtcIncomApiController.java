...
import com.lnworks.atchar.incom.service.EtcIncomingService;
...
@RestController
@RequestMapping("/incom/etcItemApi")
public class EtcIncomApiController {

    @Autowired
    EtcIncomingService incomingService;
